...
CREATE TABLE IF NOT EXISTS `SuspirarDoces`.`Estoques` (
  ...
  `dataUltimaCompra` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `SuspirarDoces`.`Receitas` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `idPedido_idx` (`idPedidoReceita` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `SuspirarDoces`.`Usuarios`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `SuspirarDoces`.`Usuarios` ;

CREATE TABLE IF NOT EXISTS `SuspirarDoces`.`Usuarios` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(20) CHARACTER SET 'utf8mb4' NOT NULL,
